...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(230, 2);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(845, 455);
			...
			this->openFileDialog1->InitialDirectory = L"D:\\універ\\2 куркурс\\grafik\\Project4\\Project4";
			// 
			// MyForm
			// 
			...
			this->ClientSize = System::Drawing::Size(1076, 457);
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		if (openFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
			if (figure->LoadFromFile(openFileDialog1->FileName)) {
				...
				g->Clear(Color::White);
				figure->Draw(g, pictureBox1->Width, pictureBox1->Height);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		else if (textBox6->Text == "1") figure->Rotate(angle, 'y');
		else if (textBox5->Text == "1") figure->Rotate(angle, 'z');
		...
		MessageBox::Show("Помилка! Перевірте кут та вісь.");
	}
}
};
}
